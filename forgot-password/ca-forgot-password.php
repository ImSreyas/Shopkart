        ...
        if(isset($_SESSION['ca-username'])){
            ...
            $passErr2="";
             if($_SERVER["REQUEST_METHOD"]=="POST"){
                ...
                if(!preg_match("/(?=.*\d).(?=.*[a-zA-Z]).(?=.*[\!\@\#\$\%\^\&\*]).{6,25}+$/",$pass) 
                ...
                if($passErr=="" && $passErr2=="")
                {
                    $username=$_SESSION['ca-username'];
                    include('../data-base/constant.php');
                    $pass_d=md5($pass);
                    $sql="UPDATE customer_login SET password='$pass_d' WHERE username='$username'";
            ...
            ?>
            <?php include('../animated/forpassca.php'); ?>
            <div class="ca-phn">
                <form action="" method="post" id="pp">
                    <label for="user-pass">New password</label>

                    <div class="forgot-pass-wrap">
                    <input id="user-pass" name="user-pass" placeholder="Enter your password" value="<?php echo $pass; ?>"
                    <?php if($passErr!="")echo "class='shake'"; ?>><br>
                    ...
                    <div class="forgot-pass-wrap">
                    <input id="user-pass2" name="user-pass2" placeholder="Confirm your password" value="<?php echo $pass2; ?>" 
                    <?php if($passErr2!="")echo "class='shake'"; ?>><br>
                ...
                <div class="pass-note">
                <span style="color:<?php if($passErr=="*Password is not strong")echo "red";else echo "black"; ?>;">
