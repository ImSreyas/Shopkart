        ...
        <?php
            ...
            <div class="ca-phn">
                <form action="" method="post" id="pp">
                    ...
                    <input id="seller-pass" name="seller-pass" placeholder="Enter your password" value="<?php echo $pass; ?>"
                    ...
                    <div class="forgot-pass-wrap">
                    <input id="seller-pass2" name="seller-pass2" placeholder="Confirm your password" value="<?php echo $pass2; ?>" 
            ...
            <?php include('../animated/passsa.php'); ?>
