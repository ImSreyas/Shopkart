...
<html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <link rel="stylesheet" type="text/CSS" href="css/ca-phone.css">
    </head>
    <body class="my-body">
        <!--menu-->
            ...
            <div class="ca-phn">
                ...
                if($_SERVER["REQUEST_METHOD"]=="POST"){
                    ...
                    if(preg_match('/^[0-9]{10}+$/',$phone)){
                        $sql="SELECT username FROM customer_login WHERE username='$phone'";
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <label for="user-phone">Phone</label><a class="no-text-decoration" href="ca-email.php"><span class="mailedit">Email</span></a>
                    <br>
                    <input type="text" id="user-phone" name="user-phone" placeholder="Enter your phone number" 
                    value="<?php echo $phone; ?>"
                    <?php if($phoneErr!="")echo "class='shake'"; ?>>
                    <br>
                    <span class="error"><?php echo $phoneErr; ?></span>
                    <?php if($phoneErr=="*User already exist")echo "<span class='us-ex'><a href='../log-in.php'>log-in</a></span>"?>
                    <br>
                    <input type="submit" id="send-otp" name="check" value="send OTP">
                </form>
            </div>
            <?php include('../animated/phoneca.php'); ?>
            </div>
