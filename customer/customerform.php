    ...
    <body class="my-body">
        ...
        <div class="body1 body3">
            ...
            <form class="form4578" action="" method="POST">
                ...
                value="<?php echo $name; ?>" 
                style="border: 2px solid; border-color :<?php if($nameErr!='')echo 'red';else echo 'white'; ?>;"
                <?php if($nameErr!="")echo "class='shake'"; ?>/><br><br>
                ...
                style="border: 2px solid; border-color :<?php if($locationErr!='')echo 'red';else echo 'white'; ?>;"
                <?php if($locationErr!="")echo "class='shake'"; ?>/><br><br>
                ...
                style="border: 2px solid; border-color :<?php if($addressErr!='')echo 'red';else echo 'white'; ?>;"
                <?php if($addressErr!="")echo "class='shake'"; ?>></textarea><br><br>
                ...
                style="border: 2px solid; border-color :<?php if($emailErr!='')echo 'red';else echo 'white'; ?>;"
                <?php if($emailErr!="")echo "class='shake'"; ?>/><br><br>
                ...
                style="border: 2px solid; border-color :<?php if($phone1Err!='')echo 'red';else echo 'white'; ?>;"
                <?php if($phone1Err!="")echo "class='shake'"; ?>/><br><br>
                ...
                style="border: 2px solid; border-color :<?php if($phone2Err!='')echo 'red';else echo 'white'; ?>;"
                <?php if($phone2Err!="")echo "class='shake'"; ?>/><br><br>

                <label for="customerpin">Pin</label>
                <input type="text" id="customerpin" 
                name="customerpin" 
                placeholder="Enter your pin (required)" 
                value="<?php echo $pin; ?>" 
                style="border: 2px solid; border-color :<?php if($pinErr!='')echo 'red';else echo 'white'; ?>;"
                <?php if($pinErr!="")echo "class='shake'"; ?>/><br><br><br>

                <input type="submit" id="createacc" value="Create">
            </form>
            </div>
            <?php include('../animated/formca.php'); ?>
